...
if __name__ == "__main__":
    ...
    cur_counter = 240
    train = train.iloc[(cur_counter-20) * 1000 : cur_counter * 1000]
    ...
    data[["pairID", "string_subj_s1", "string_verb_s1", "string_obj_s1", "string_loc_s1", "string_clo_s1",
          "string_subj_s2", "string_verb_s2", "string_obj_s2", "string_loc_s2", "string_clo_s2", "vecs"]].to_pickle('prepared_data/subphrase_vectors_' + str(cur_counter) + data_name + '.pkl')
