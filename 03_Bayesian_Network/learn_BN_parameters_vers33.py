...
if __name__ == "__main__":
    ...
    if not continue_training:
        prev_iter = 0
    prev_directory = 'vers33/MLP_Classifiers_' + str(amount_training_data) + 'k_training_' + str(prev_iter) + '_iter_' + 'NN_size_' + str_size_hidden
    folder_name = 'vers33/MLP_Classifiers_' + str(amount_training_data) + 'k_training_' + str(prev_iter + em_iter) + '_iter_' + 'NN_size_' + str_size_hidden
