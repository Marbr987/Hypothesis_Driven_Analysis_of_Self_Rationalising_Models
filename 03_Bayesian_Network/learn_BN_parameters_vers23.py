...
if __name__ == "__main__":
    ...
    em_iter = 20
    mlp_iter = 30
    size_hidden_layers = (200, 200, 200, 200, 50, 50, 50, 50, 30, 30, 30)
    str_size_hidden = '_'.join([str(i) for i in size_hidden_layers])
    prev_directory = 'vers23/MLP_Classifiers_' + str(amount_training_data) + 'k_training_' + str(em_iter) + '_iter_' + 'NN_size_' + str_size_hidden
    folder_name = 'vers23/MLP_Classifiers_' + str(amount_training_data) + 'k_training_' + str(continue_iter + em_iter) + '_iter_' + 'NN_size_' + str_size_hidden
